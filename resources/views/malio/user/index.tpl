                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="buttons">
                        ...
                        <a href="##" class="btn btn-icon icon-left btn-primary btn-kitsunebi copy-text btn-lg btn-round" data-clipboard-text="{$subInfo['kitsunebi']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i class="malio-kitsunebi"></i> 复制 Kitsunebi 订阅链接</a>
                        {/if}
                        ...
                        <a href="##" class="btn btn-icon icon-left btn-primary btn-v2ray copy-text btn-lg btn-round" data-clipboard-text="{$subInfo['v2ray']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i class="malio-v2rayng"></i> 复制 V2Ray 订阅链接</a>
                        {/if}
                        {if (in_array("ss",$malio_config['support_sub_type']))}
                        <a href="##" class="btn btn-icon icon-left btn-primary btn-ss copy-text btn-lg btn-round" data-clipboard-text="{$subInfo['ss']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i class="malio-ssr"></i> 复制 SS 订阅链接</a>
                        <a href="##" class="btn btn-icon icon-left btn-primary btn-quantumult copy-text btn-lg btn-round" data-clipboard-text="{$subInfo['ssd']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i class="malio-ssr"></i> 复制 SSD 订阅链接</a>
