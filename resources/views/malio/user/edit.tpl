            ...
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-pills flex-column" id="settings" role="tablist">
                      ...
                      {if $malio_config['enable_reset_port'] == true}<li class="nav-item"><a class="nav-link" id="resetport-tab" data-toggle="tab" href="#resetport" role="tab" aria-controls="resetport" aria-selected="false">重置端口</a></li>{/if}
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-md-8">
                <div class="tab-content no-padding" id="settings2Content">
                  ...
                  {if $malio_config['enable_reset_port'] == true}
