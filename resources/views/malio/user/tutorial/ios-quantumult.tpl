                      ...
                      <div class="row mt-2">
                        <div id="manual-import" class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                          ...
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$baseUrl}/link/{$sub_token}?type=ss">点此复制 SS 订阅链接</a>，打开 Quantumult，轻点底栏的设置，轻点订阅，轻点右上角的+，选择服务器，填入名称为 {$config['appName']} ，粘贴订阅链接，最后保存即可。
                          </p>
                        </div>
