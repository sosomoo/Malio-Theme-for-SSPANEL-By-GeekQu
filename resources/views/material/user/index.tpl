											...
											<div class="tab-content">
												...
												<div class="tab-pane fade active in" id="sub_center">
													...
													<div class="tab-pane fade active in" id="sub_center_windows">
														...
														<hr/>
														<p><span class="icon icon-lg text-white">filter_9</span> 其他应用 - [ SS/SSR/VMess ]：</p>
															<p>个人端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=3"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>													</div>
													...
													<div class="tab-pane fade" id="sub_center_ios">
														...
														<p><span class="icon icon-lg text-white">filter_2</span> <a class="btn-dl" href="https://itunes.apple.com/us/app/kitsunebi-proxy-utility/id1446584073?ls=1&mt=8"><i class="material-icons">save_alt</i> GET</a> Kitsunebi - [ SS/VMess ]：</p>
															<p>个人端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=3&mu=0"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=4&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS + V2 混合订阅</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=3&mu=1"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=4&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS + V2 混合订阅</a></p>
														<hr/>
														<p><span class="icon icon-lg text-white">filter_3</span> <a class="btn-dl" href="https://itunes.apple.com/us/app/quantumult/id1252015438?ls=1&mt=8"><i class="material-icons">save_alt</i> GET</a> Quantumult - [ SS/SSR/VMess ]：</p>
															<p>个人端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?quantumult=1&mu=0"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?quantumult=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>完整配置</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?quantumult=1&mu=1"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?quantumult=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>完整配置</a></p>
														<hr/>
														<p><span class="icon icon-lg text-white">filter_4</span> <a class="btn-dl" href="https://itunes.apple.com/us/app/shadowrocket/id932747118?mt=8"><i class="material-icons">save_alt</i> GET</a> Shadowrocket - [ SS/SSR/VMess ]：</p>
															<p>个人端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=5&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS(R) + V2 订阅</a>.<a class="btn-dl" href="javascript:void(0);" data-onekeyfor="sub0" value="{$subUrl}{$ssr_sub_token}?sub=5&mu=0"><i class="material-icons icon-sm">how_to_vote</i>一键混合订阅</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=5&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS(R) + V2 订阅</a>.<a class="btn-dl" href="javascript:void(0);" data-onekeyfor="sub0" value="{$subUrl}{$ssr_sub_token}?sub=5&mu=1"><i class="material-icons icon-sm">how_to_vote</i>一键混合订阅</a></p>
														<hr/>
														<p><span class="icon icon-lg text-white">filter_9</span> 其他应用 - [ SS/SSR/VMess ]：</p>
															<p>个人端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=3"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>													</div>
													<div class="tab-pane fade" id="sub_center_android">
														...
														<hr/>
														<p><span class="icon icon-lg text-white">filter_9</span> 其他应用 - [ SS/SSR/VMess ]：</p>
															<p>SS/SSR/SSRR/Outline/V2rayNG/BifrostV/Kitsunebi</p>
															<p>个人端口：<a class="copy-text copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=0"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>
															<p>公共端口：<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=3"><i class="material-icons icon-sm">how_to_vote</i>V2 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=2&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SS 订阅</a>.<a class="copy-text btn-dl" data-clipboard-text="{$subUrl}{$ssr_sub_token}?sub=1&mu=1"><i class="material-icons icon-sm">how_to_vote</i>SSR 订阅</a></p>
													</div>
												</div>
