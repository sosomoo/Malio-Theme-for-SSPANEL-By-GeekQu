...
未使用 " . $user->unusedTraffic() . " " . number_format(($user->transfer_enable - ($user->u + $user->d)) / $user->transfer_enable * 100, 2) . "%
                ...
                case "rss":
                    ...
                    $reply_message = "SSR普通订阅: ". $subUrl.$ssr_sub_token."?mu=0\n".
                        ...
                        "CLASH配置文件订阅地址: ".$subUrl.$ssr_sub_token."?mu=4\n".
                        "Shadowrocket(普通订阅): ".$subUrl.$ssr_sub_token."?mu=0&app=1\n".
                        "Shadowrocket(单端口): ".$subUrl.$ssr_sub_token."?mu=1&app=1\n".
                        "Kitsunebi(普通订阅): ".$subUrl.$ssr_sub_token."?mu=0&app=2\n".
                        "Kitsunebi(单端口节点订阅): ".$subUrl.$ssr_sub_token."?mu=1&app=2\n".
                        "Quantumult(Vmess订阅): ".$subUrl.$ssr_sub_token."?mu=0&quantumult=1";
